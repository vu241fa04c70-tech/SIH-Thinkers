    ...
    <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-md space-y-4 text-slate-900">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-500 font-medium mt-0.5">This chart shows estimated emissions from different vehicle and fuel types.</p>
        </div>
      ...
      <div className="h-72 w-full">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={emissionData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
            ...
            <Legend />
            <Bar dataKey="co2" name="CO₂ Emissions (kg)" fill="#10b981" radius={[4, 4, 0, 0]} />
            <Bar dataKey="ch4" name="CH₄ Gas Equivalent (kg)" fill="#3b82f6" radius={[4, 4, 0, 0]} />
            <Bar dataKey="n2o" name="N₂O Gas Equivalent (kg)" fill="#8b5cf6" radius={[4, 4, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
